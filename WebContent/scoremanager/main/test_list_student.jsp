        ...
        <div class="main">
            ...
            %>
                <table>
                    ...
                    <tbody>
                        <%
                            for (TestListStudent row : resultList) {
                        %>
                            <tr>
                                <td><%= row.getSubjectName() %></td>
                                <td><%= row.getSubjectCd() %></td>
                                <td><%= row.getNum() %></td>
                                <td><%= row.getPoint() %></td>
                            </tr>
                        <%
            ...
            <%
                    ...
                    if (lackError == null && nothingError == null && errorMessage == null) {
            %>
                <div class="error-msg">該当する成績情報が存在しませんでした</div>
            <%
                    }
                }
            %>
